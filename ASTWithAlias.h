...
public:
    ...
    void appendColumnName(std::ostringstream & ostr) const final;
    void appendColumnNameWithoutAlias(std::ostringstream & ostr) const final;
...
protected:
    virtual void appendColumnNameImpl(std::ostringstream & ostr) const = 0;
};
