...
public:
    ...
    bool operator< (const Field & rhs) const
    {
        ...
        switch (which)
        {
            ...
            case Types::UInt128: throw Exception("Bad type of Field");
            case Types::UInt256: throw Exception("Bad type of Field");
            case Types::Int64:   return get<Int64>()   < rhs.get<Int64>();
            case Types::Int128:  throw Exception("Bad type of Field");
            case Types::Int256:  throw Exception("Bad type of Field");
            case Types::UUID:    throw Exception("Bad type of Field");
            case Types::Float64: return get<Float64>() < rhs.get<Float64>();
            case Types::String:  return get<String>()  < rhs.get<String>();
            case Types::Array:   return get<Array>()   < rhs.get<Array>();
            case Types::Tuple:   return get<Tuple>()   < rhs.get<Tuple>();
            case Types::Map:     return get<Map>()     < rhs.get<Map>();
            case Types::Decimal32:  throw Exception("Bad type of Field");
            case Types::Decimal64:  throw Exception("Bad type of Field");
            case Types::Decimal128: throw Exception("Bad type of Field");
            case Types::Decimal256: throw Exception("Bad type of Field");
    ...
    static auto dispatch(F && f, FieldRef && field)
    {
        switch (field.which)
        {
            case Types::Null:    throw Exception("Bad type of Field");
            case Types::NegativeInfinity:    throw Exception("Bad type of Field");
            case Types::PositiveInfinity:    throw Exception("Bad type of Field");
// gcc 8.2.1
#if !defined(__clang__)
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Wmaybe-uninitialized"
...
private:
    std::aligned_union_t<DBMS_MIN_FIELD_SIZE - sizeof(Types::Which),
        UInt64, Int64, Float64, String, Array, Tuple, Map, 
...
NearestFieldType<std::decay_t<T>> & Field::get()
{
    ...
    if (target != which
        ...
        throw Exception(String("Invalid Field get from type ") + Types::toString(which) + " to type " + Types::toString(target));
#endif
...
[[noreturn]] inline void readText(Map &, ReadBuffer &) { throw Exception("Cannot read Map."); }
...
__attribute__ ((noreturn)) inline void writeText(const AggregateFunctionStateData &, WriteBuffer &)
{
    ...
    throw Exception("Cannot convert a Field of type AggregateFunctionStateData to human-readable text");
}
