...
void ASTFunction::appendColumnNameImpl(std::ostringstream & ostr) const
{
    if (name == "view")
        throw Exception("Table function view cannot be used as an expression");
...
{
    throw Exception("ASTFunction::formatImplWithoutAlias is not implemented");
